...
for mesh in mesh_list[100:]:
    try:
        ...
        for day in dayss:
            ...
            try:
                matched = pd.read_csv("C:\\Users\hysir\Desktop\研究室\matching\original_data\car_E\\20220509_car_E_.csv_\\all_ex_prema.csv")
                pre = pd.read_csv("C:\\Users\hysir\Desktop\研究室\matching\original_data\car_E\\20220509_car_E_.csv_\\premesh20220509_bus_B_mesh.csv")
                ...
                #print(mean)
                os.makedirs("C:\\Users\hysir\Desktop\研究室\matching\original_data\car_E\distance\\" + str(
                    mesh_srt) + "_" + bus_type + "_" + which_going, exist_ok=True)

                df = pd.DataFrame(distance, columns=["distance", "latitude", "longitude"])
                df.to_csv("C:\\Users\hysir\Desktop\研究室\matching\original_data\car_E\distance\\" + str(
                    mesh_srt) + "_" + bus_type + "_" + which_going+"/"+day+"_"+str(mesh_srt)+"_"+bus_type+"_"+which_going+".csv")
                print("finish")
            except Exception as e:
                print(e)
